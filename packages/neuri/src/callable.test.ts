...
describe('callable', () => {
  it('should handle toJSONSchema', () => {
    const callable = defineCallable<[string], string>()
      ...
      .withParameter({ name: 'param', description: 'param description', type: 'string', required: true })
      .withReturn({ name: 'return', description: 'return description', type: 'string', required: true })
...
describe('callableComponent', () => {
  it('should handle toToolsJSONSchema', () => {
    ...
    const functionAdd = () => defineCallable<[number, number], number>()
      ...
      .withParameter({ name: 'a', description: 'a description', type: 'number', required: true })
      .withParameter({ name: 'b', description: 'b description', type: 'number', required: true })
      .withReturn({ name: 'return', description: 'return description', type: 'number', required: true })
